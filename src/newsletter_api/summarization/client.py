        ...
        try:
            for max_chars in (3200, 1600):
                prompt = (
                    ...
                    "문체는 논문 초록처럼 무겁지 않게, 기술 커뮤니티 브리핑 + 설명형 어투로 작성하세요. "
                    "단순 나열이 아니라 '왜 중요한지'와 '실무에서 무엇이 달라지는지'를 명확히 설명하세요. "
                    "사용자는 원문 링크를 보지 않는다고 가정하고 맥락, 근거, 실행 포인트를 충분히 담아주세요.\\n"
                    ...
                    "messages": [
                        {
                            ...
                            "content": (
                                ...
                                "학술 논문체 대신 개발자 커뮤니티 브리핑 스타일과 설명형 어투를 사용하세요."
                            ),
                        },
